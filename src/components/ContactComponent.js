...
import {Button, Form,FormGroup,Label, Input, Col } from 'reactstrap'; //para los forms
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col  md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="Lirst Name" value={this.state.lastname}
                                    onChange={this.handleInputChange}/> 
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col  md={10}>
                                    <Input type="textarea" id="message" name="message" placeholder="Your Feedback" value={this.state.message} rows="12"
                                    onChange={this.handleInputChange}/> 
                                </Col>
                            </FormGroup>
